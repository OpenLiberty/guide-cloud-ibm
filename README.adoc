...
Since you built a new image, it will have to be pushed to the repository again. Remember to replace `us.icr.io to` your registry and `[your-namespace]` with the namespace you created earlier in the guide.
