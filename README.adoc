...
hosted {kube} cluster that you can deploy your microservices to. You will use it in 
conjunction with IBM Cloud Container Registry. IBM Cloud Container Registry is a private 
registry used to store and distribute your container images. 
