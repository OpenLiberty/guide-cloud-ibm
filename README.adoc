...
{kube} cluster and to manage releases in your {kube} cluster. Download https://github.com/helm/helm/releases/tag/v2.13.1[Helm^]
and see the official https://helm.sh/docs/using_helm/#installing-helm[Installing Helm^] 
...
The registry you will use is called IBM Cloud Container Registry. To install the container 
registry plugin, run the following command:
