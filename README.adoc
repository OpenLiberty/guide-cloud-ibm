...
// Deploy to IKS
Use Helm to deploy the `system` microservice. Remeber to substitute `[your-namespace]` for the namespace you created earlier in the guide.
...
Use Helm to deploy the `inventory` microservice. Remeber to substitute `[your-namespace]` for the namespace you created earlier in the guide.
