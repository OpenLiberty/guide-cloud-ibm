...
the ports before making requests to our services. We must also onbtain the public IP address 
...
[role=command]
```
docker tag name:2.0-SNAPSHOT registry.ng.bluemix.net/[your-namespace]/name:2.0-SNAPSHOT
```
...
[role=command]
```
docker push registry.ng.bluemix.net/[your-namespace]/name:2.0-SNAPSHOT
```
