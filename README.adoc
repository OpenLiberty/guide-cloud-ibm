...
deploys and manages them as releases in your cluster. You will use IKS with IBM Cloud Container Registry.
IBM Cloud Container Registry is a private registry used to store and distribute your
container images.
...
https://www.ibm.com/cloud/private[IBM Cloud Private^] (ICP) is a on-premises {kube} platform from IBM. 
