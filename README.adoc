...
:page-majorupdateddate: 2022-11-11
...
Since you built a new image, it will have to be pushed to the repository again. On the following `docker` and `kubectl` commands, remember to replace `us.icr.io to` your registry and `[your-namespace]` with the namespace you created earlier in the guide.
