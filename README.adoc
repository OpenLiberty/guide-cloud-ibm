...
:page-seo-description: Learn how push Docker images to a custom registry and run your microservices inside of containers on IKS and ICP.
:guide-author: Open Liberty
= Deploying microservices to IKS and ICP
