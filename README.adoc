...
The registry that you will use is called IBM Cloud Container Registry.
...
[role=command]
```
docker tag system:1.0-SNAPSHOT registry.ng.bluemix.net/[your-namespace]/system:1.0-SNAPSHOT
docker tag inventory:1.0-SNAPSHOT registry.ng.bluemix.net/[your-namespace]/inventory:1.0-SNAPSHOT
```
...
[role=command]
```
docker push registry.ng.bluemix.net/[your-namespace]/system:1.0-SNAPSHOT
docker push registry.ng.bluemix.net/[your-namespace]/inventory:1.0-SNAPSHOT
```
...
helm install --name system-app \
    --set image.repository=registry.ng.bluemix.net/[your-namespace]/system \
...
helm install --name inventory-app \
    --set image.repository=registry.ng.bluemix.net/[your-namespace]/inventory \
    --set image.tag=1.0-SNAPSHOT \
...
[role=command]
```
docker tag system:2.0-SNAPSHOT registry.ng.bluemix.net/[your-namespace]/system:2.0-SNAPSHOT
```
...
[role=command]
```
docker push registry.ng.bluemix.net/[your-namespace]/system:2.0-SNAPSHOT
```
